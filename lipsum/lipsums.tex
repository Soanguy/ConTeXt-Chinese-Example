...
\startxtable[split=yes,width=.2\dimexpr\textwidth+\rightmarginwidth\relax]
	\startxrow
        ...
        \startxcell \colorshowtemp {softthemecolor} \stopxcell
        \startxcell \colorshowtemp {lightthemecolor} \stopxcell
        \startxcell \colorshowtemp {darkthemecolor} \stopxcell
        \startxcell \colorshowtemp {softthemecolorv} \stopxcell
     \stopxrow\startxrow
        \startxcell \colorshowtemp {altcolorv} \stopxcell
        \startxcell \colorshowtemp {optcolor} \stopxcell
...
%        \startxcell \colorshowtemp {textcolor} \stopxcellblack
	...
	\startxrow
        ...
        \startxcell \bgcolorshowtemp {softthemecolor} \stopxcell
        \startxcell \bgcolorshowtemp {lightthemecolor} \stopxcell
        \startxcell \bgcolorshowtemp {darkthemecolor} \stopxcell
        \startxcell \bgcolorshowtemp {softthemecolorv} \stopxcell
     \stopxrow\startxrow
        \startxcell \bgcolorshowtemp {altcolorv} \stopxcell
        \startxcell \bgcolorshowtemp {optcolor} \stopxcell
